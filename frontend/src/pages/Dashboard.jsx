    ...
    if (loading) return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
            <div className="bg-white rounded-3xl p-12 border border-gray-200 shadow-lg">
                <Loader2 className="animate-spin text-gray-600 mb-4 mx-auto" size={48} />
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-3 sm:gap-4">
                            <div className="relative group flex-1 sm:flex-none">
                                <Filter size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 group-hover:text-gray-700 transition-colors" />
                                <select
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-8">
                    ...
                    >
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg lg:rounded-xl flex items-center justify-center shadow-sm">
                                <BarChart3 size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-blue-600" />
                            </div>
                    ...
                    >
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg lg:rounded-xl flex items-center justify-center shadow-sm">
                                <AlertCircle size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-orange-600" />
                            </div>
                            <div className="flex-1 min-w-0">
                    ...
                    >
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg lg:rounded-xl flex items-center justify-center shadow-sm">
                                <Users size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-blue-600" />
                            </div>
                            <div className="flex-1 min-w-0">
                    ...
                    >
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-green-100 to-green-200 rounded-lg lg:rounded-xl flex items-center justify-center shadow-sm">
                                <BarChart3 size={20} className="sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-green-600" />
                            </div>
                            <div className="flex-1 min-w-0">
                    ...
                    {issues.length === 0 ? (
                        ...
                        >
                            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                                <AlertCircle size={32} className="sm:w-10 sm:h-10 text-gray-400" />
                            </div>
                        ...
                        >
                            <AlertCircle size={40} className="sm:w-12 sm:h-12 text-gray-300 mx-auto mb-3 sm:mb-4" />
