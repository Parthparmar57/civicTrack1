...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 pt-16 relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50">
            {/* Background Elements */}
            ...
            >
                <div className="glass p-10 rounded-3xl shadow-2xl relative overflow-hidden border border-white/40">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-black text-gray-900 mb-3">Welcome Back</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 bg-indigo-50 rounded-lg flex items-center justify-center">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-4 py-4 bg-white/80 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all backdrop-blur-sm shadow-sm"
                                />
                            </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full pl-14 pr-14 py-4 bg-white/80 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all backdrop-blur-sm shadow-sm"
                                />
                                <button
                                    type="button"
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={loading}
                            className={`w-full py-4 rounded-xl text-white font-bold text-lg shadow-2xl flex items-center justify-center gap-3 transition-all ${loading
                                ? 'bg-gray-400 cursor-not-allowed opacity-70'
                                : 'bg-gradient-to-r from-primary via-secondary to-accent-orange hover:shadow-primary/30'
                                }`}
                        >
                            {loading ? (
