...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 pt-16 relative overflow-hidden bg-blue-50">
            {/* Background Elements */}
            ...
            >
                <div className="glass p-10 rounded-3xl shadow-2xl relative overflow-hidden border border-white/40">
                    ...
                    <div className="text-center mb-10">
                        ...
                        >
                            <LogIn size={36} className="text-black" />
                        </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-4 py-4 bg-white/80 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition-all backdrop-blur-sm shadow-sm"
                                />
                            </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full pl-14 pr-14 py-4 bg-white/80 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/20 transition-all backdrop-blur-sm shadow-sm"
                                />
                                <button
                                    type="button"
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    Sign In <ArrowRight size={20} className="text-black" />
                                </>
                            )}
                        </motion.button>
                    </form>
